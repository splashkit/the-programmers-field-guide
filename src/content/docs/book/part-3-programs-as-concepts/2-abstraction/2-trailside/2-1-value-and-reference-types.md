...
Value types in C# include the primitive types such as `int`, `double`, and `bool` but also include [structs](/book/part-2-organised-code/2-structuring-data/5-reference/03-01-struct) which you can define.
