...
Within a class we can also [overload](/book/part-1-instructions/1-sequence/5-reference/03-method-call#overloading) methods, just like we could with functions and procedures in C++.
