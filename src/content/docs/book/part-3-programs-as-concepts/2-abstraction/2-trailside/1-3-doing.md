...
Within a class we can also [overload](/book/part-1-instructions/1-sequence/2-trailside/03-method-call#overloading) methods, just like we could with functions and procedures in C++.
