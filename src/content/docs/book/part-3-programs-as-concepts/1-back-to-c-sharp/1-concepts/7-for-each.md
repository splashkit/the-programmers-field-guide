...
:::note
Your objects in C# will be [reference types](../../../2-abstraction/1-concepts/0-value-and-reference-types) which means you will be able to use the `foreach` loop to access and work with the objects in the array or list. We will revisit this in the next chapter.
:::
