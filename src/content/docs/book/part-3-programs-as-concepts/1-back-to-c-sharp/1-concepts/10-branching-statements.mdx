...
Selection, or branching, statements allow you to add places in your code where a decision is made and one of a number of paths is chosen. The most common of these is the **if statement**. Using the if statement you can choose whether some code is executed or skipped. You can also have an optional **else** branch which is run if the main branch is skipped.
