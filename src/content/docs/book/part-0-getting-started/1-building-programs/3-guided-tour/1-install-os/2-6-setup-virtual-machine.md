...
Once you have set up your virtual machine with Debian, you can follow the installation steps on the [Set up my Linux Box](/book/part-0-getting-started/1-building-programs/3-guided-tour/1-install-os/2-0-setup-linux) page to finish setting up your virtual machine.
