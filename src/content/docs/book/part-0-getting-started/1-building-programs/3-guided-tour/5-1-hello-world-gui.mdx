...
We'll go a little more briskly this time - if you get stuck at any point you can always check the [previous pages](../3-first-project/).
<Steps>
1. Create a C++ file
...
<summary>You've written down your guesses? Let's see how they compare:</summary>
    ...
    Conceptually yes! At the command line, we run a program by writing its _name_, and then a series of _parameters_ (or _arguments_). For instance when we write:
        ...
        The underlying technical aspects between the two are quite different, but conceptual they are very similar. Understanding this pattern early on will make reading code much easier :)
    </details>
</details>
...
Now let's try changing it! See you in the [next section](../5-2-hello-world-gui-edit).
