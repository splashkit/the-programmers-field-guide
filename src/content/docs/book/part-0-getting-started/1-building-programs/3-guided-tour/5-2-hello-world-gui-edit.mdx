...
Continuing from the [previous section](/book/part-0-getting-started/1-building-programs/3-guided-tour/5-1-hello-world-gui/), we've briefly analysed the GUI Hello World, and are ready to try customizing it.
