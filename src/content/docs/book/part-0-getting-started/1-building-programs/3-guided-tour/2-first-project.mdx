...
1. Open **Visual Studio Code**
    ...
    If the option is not available make sure you have [WSL installed correctly](/book/part-0-getting-started/1-building-programs/3-intro-tour/1-install-os/2-5-setup-win-wsl), and the WSL extension for VS Code.
    :::
</Steps>
