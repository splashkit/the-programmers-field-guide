...
2. Copy the following code and paste it into your new file.
3. Use what you have learnt from this chapter to compile and run this program.
    :::tip
    Do this without referencing the material. You want to test that you know how to do this yourself. As you progress, you will be building and running many programs, so you need to develop the skills to do this quickly.
    :::
</Steps>
