...
<div class="not-content">
  <YouTube id="c8CzoOuOGaA" params="fs=1&modestbranding=1&rel=0&autoplay=1"/>
</div>
...
In this chapter we will explore the [concepts](/book/part-0-getting-started/1-digital-realities/2-trailside/1-programs) that underpin computing. Sights on our tour include:
