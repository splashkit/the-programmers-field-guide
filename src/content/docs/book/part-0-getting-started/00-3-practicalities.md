...
Here are some answers to practical questions you might have.
...
You don't need anything super expensive to learn the basics of programming. Everything we do here works perfectly well on a [Raspberry Pi](https://www.raspberrypi.org). With a PI, some components, and a Maker space, you could even put together something of your own.

:::

### Others to learn with

Another good thing to have is company. While you can travel this journey solo, it is usually better with friends. An ideal travel group would include an experienced guide and some companions who are also taking the trip for the first time. If you are at school or university, this will be your tutor and fellow students. Your tutor can help you engage with ideas and provide you with feedback on activities as you go. Your fellow students can help you learn by discussing ideas together and sharing the successes and challenges you encounter along the way.
...
This book focuses on building your mental model and helping you learn how to program. The focus is not on a particular language, but on things that are common across many languages. What you will learn is *more* than just a programming language. By the end of your journey, you will be capable of quickly picking up and using many programming languages.

However, the examples and activities in this book will use a specific language. This will give you the chance to practice what you are learning and help you build a strong mental model. Where we can, we'll also show you how each concept exists or is different in other languages.
...
This journey should be fun. While reading and writing text from the terminal can demonstrate all the programming features, it can be a bit boring. Creating visual and interactive programs will help you **see** that your programs are working as you expected.
