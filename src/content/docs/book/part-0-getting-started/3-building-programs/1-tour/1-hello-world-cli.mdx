...
We need somewhere to put our project's code. For this, we will create a folder in our **Documents/Code** folder. You should have created this folder as part of the tour in the [Computer Use](/book/appendix/2-computer-use/1-tour/3-1-terminal) chapter, but we will repeat it here just in case you missed that step.
