...
:::
{/* TODO: Charlotte's tip? This is something I found confusing! Might be able to think of a good analogy to explain the difference too... */}
...
<Tabs>
  ...
  <TabItem label="Linux">
    ...
    Follow the instructions in the [SplashKit installer](https://splashkit.io/articles/installation/ubuntu/) to install the tools you need.
  </TabItem>
  <TabItem label="macOS">
    ...
    Follow the instructions in the [SplashKit installer](https://splashkit.io/articles/installation/mac/) to install the tools you need.
  </TabItem>
