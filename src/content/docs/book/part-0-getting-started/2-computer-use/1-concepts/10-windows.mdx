...
banner:
  content: |
    This page is for the Multitool!
---
...
:::caution
If you have been using macOS or Windows, you might think you can skip this section as you have already been using a graphical user interface.
However, there are still a few things here that you will need.
Make sure to read the section on [launching the editor from the terminal](#launching-editor-from-terminal).
:::
...
Once you are in a graphical environment you can open a terminal
