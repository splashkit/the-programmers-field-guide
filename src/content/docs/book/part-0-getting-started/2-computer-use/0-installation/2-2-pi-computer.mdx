...
[Set up my Linux Box](../../0-installation/2-0-setup-linux)
:::
...
:::tip
Using your own SD card? Make sure you have installed Raspberry Pi OS on it. You can find the instructions in the [Set up my Raspberry Pi](../../0-installation/2-3-setup-pi) section.
...
To continue the setup process, continue to the next page: [Set up my Raspberry Pi](../../0-installation/2-3-setup-pi) for instructions on how to install the operating system and configure the Pi.
