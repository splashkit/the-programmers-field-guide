...
<div class="not-content">
  <YouTube id="3FnSK5NgJo0" params="fs=1&modestbranding=1&rel=0"/>
</div>
...
In this chapter we will explore the [concepts](/book/part-0-getting-started/1-building-programs/5-reference/1-programs) that underpin computing. Sights on our tour include:
