...
The great thing is that we've already written a struct like this before, with a MAX_CAPACITY constant, size, and data, back in [Handling Multiples](/book/part-2-organised-code/3-working-with-multiples/5-reference/02-00-struct-with-array) - we'll just be taking this logic, _generalising_ it, and adding some member functions.
