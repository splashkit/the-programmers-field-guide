...
In this section we will build a simple [account](/book/part-2-organised-code/4-member-functions/3-guided-tour/1-account) entity to model a bank account. In this, we will step through the mechanics of building this using a class.
