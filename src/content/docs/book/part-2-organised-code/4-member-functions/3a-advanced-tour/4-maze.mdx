...
In the chapter on [indirectly accessing values](/book/part-2-organised-code/6-indirect-access/0-overview) we started to build out a [maze game](/book/part-2-organised-code/6-indirect-access/3-guided-tour/02-maze). The idea of this was to have rooms that were connected by different paths. This is a great way of working with pointers, as the player could point to the room they were in, and paths can point to their destinations.
...
Have you noticed how the structure of the maze is similar to a [linked list](/book/part-2-organised-code/7-deep-dive-memory/3a-advanced-tour/03-0-linked-list)?
