...
The great thing is that we already have all the logic for this in the functions and procedures we build in the [previous chapter](/book/part-2-organised-code/7-deep-dive-memory/3a-advanced-tour/02-0-dynamic-array). So our task is mostly about moving things around.
