...
As you get started with this, make sure to approach things [iteratively](/book/part-2-organised-code/10-project/3-guided-tour/6-iterative-development). Do not try to do too much in any step. Get something simple working, then add a little, get it working, and repeat this until you achieve your goals.
