...
There are a few classic problems that you often encounter when exploring recursion for the first time. We will look at how you can use recursion to create the [Fibonacci sequence](/book/part-2-organised-code/1-structuring-code/5-reference/10-recursion-fibonacci) and use it to solve the [Towers of Hanoi](/book/part-2-organised-code/1-structuring-code/5-reference/10-recursion-towers).
