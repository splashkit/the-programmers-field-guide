...
:::tip[Syntax]
The syntax is the same for any [variable or constant](/book/part-1-instructions/2-data/5-reference/10-variable), whether it is global or not.
...
- [Constants](/book/part-1-instructions/2-data/5-reference/20-constant) **should** be declared globally, and used to give meaning to values that are entered into your code.
