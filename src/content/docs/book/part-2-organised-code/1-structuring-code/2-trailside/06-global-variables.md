...
- [Constants](/book/part-1-instructions/1-sequence/2-trailside/07-variable#constants) **should** be declared globally, and used to give meaning to values that are entered into your code.
