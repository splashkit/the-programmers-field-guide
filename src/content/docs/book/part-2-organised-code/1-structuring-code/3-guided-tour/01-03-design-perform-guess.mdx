...
This sequence sounds familiar. Rather than re-coding this here, we can incorporate our `read_integer` function in the program that we created [earlier](/book/part-2-organised-code/1-structuring-code/3-guided-tour/00-2-explore-functions#read-integer).
