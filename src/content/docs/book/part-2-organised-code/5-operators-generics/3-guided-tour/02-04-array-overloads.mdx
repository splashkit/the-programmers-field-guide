...
:::tip
_Personally_, I think that operator overloads can be perfectly fine when the context is clear. There are programmers that argue against even the `+` operator for `string`, but I think most of us appreciate the improved ergonomics :)
:::
