...
On Windows we suggest you use WSL2. Follow the [WSL Installation Guide](/book/appendix/0-manual-installation/2-6-setup-win-wsl#1-install-windows-subsystem-for-linux-wsl) in this book, and then install DCC on your WSL2 instance.
