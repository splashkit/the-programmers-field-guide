...
- [For Loop](/book/part-2-organised-code/3-working-with-multiples/5-reference/01-00-for-loop): A loop that can be used to easily repeat a block of code for each element of an array.
