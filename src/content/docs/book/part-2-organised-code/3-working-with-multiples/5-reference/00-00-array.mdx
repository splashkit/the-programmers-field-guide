...
- You can store a value in an element of an array using an [assignment statement](/book/part-2-organised-code/3-working-with-multiples/5-reference/00-02-assign-element).
- You can use the value from an element of an array in an [expression](/book/part-2-organised-code/3-working-with-multiples/5-reference/00-03-expressions-with-arrays).
- The [for loop](/book/part-2-organised-code/3-working-with-multiples/5-reference/01-00-for-loop) works perfectly with an array, you can repeat an action *for each element of an array*.
...
Arrays store multiple values, with an index that provides access to the individual elements within the array. Conceptually this can be viewed as a [variable](/book/part-1-instructions/2-data/5-reference/10-variable) that contains multiple slots (the elements) into which the values are stored.
