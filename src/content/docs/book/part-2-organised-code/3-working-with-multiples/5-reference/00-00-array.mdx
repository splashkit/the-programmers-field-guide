...
- The [for loop](/book/part-2-organised-code/3-working-with-multiples/5-reference/02-00-for-loop) works perfectly with an array, you can repeat an action *for each element of an array*.
