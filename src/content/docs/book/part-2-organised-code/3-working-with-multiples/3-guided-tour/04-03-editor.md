...
:::tip
Remember you need a [type cast](/book/part-2-organised-code/2-structuring-data/5-reference/03-02-enum/#underlying-representation-and-casting) here. This will tell the compiler that you want to treat the integer as a `tile_kind`.
:::
