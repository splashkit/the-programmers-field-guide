...
Here is our iteration. We have added an ability to switch between playing and editing the map. We can now randomise the map, and see the different tiles that make up the map. In editor mode, the user can update the map using their mouse.
