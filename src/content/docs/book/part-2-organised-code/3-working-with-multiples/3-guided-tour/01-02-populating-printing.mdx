...
- Use a [for loop](/book/part-2-organised-code/3-working-with-multiples/5-reference/01-00-for-loop) to perform an action *for each* element in the array.
...
- As before, use a [for loop](/book/part-2-organised-code/3-working-with-multiples/5-reference/01-00-for-loop) to perform the action for each element in the array.
