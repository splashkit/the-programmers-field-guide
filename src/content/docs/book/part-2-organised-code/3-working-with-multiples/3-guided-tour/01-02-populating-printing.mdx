...
- Use a [for loop](/book/part-2-organised-code/3-working-with-multiples/move-0-panorama/1-array-iteration) to perform an action *for each* element in the array.
...
- As before, use a [for loop](/book/part-2-organised-code/3-working-with-multiples/move-0-panorama/1-array-iteration) to perform the action for each element in the array.
