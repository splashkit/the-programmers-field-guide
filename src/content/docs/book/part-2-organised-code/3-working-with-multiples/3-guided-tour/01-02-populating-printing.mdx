...
1. The [for loop](/book/part-2-organised-code/3-working-with-multiples/5-reference/01-00-for-loop) is used to repeat the loop once for each element to add to the array.
