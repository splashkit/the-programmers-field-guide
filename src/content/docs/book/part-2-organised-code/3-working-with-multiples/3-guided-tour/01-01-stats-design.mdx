...
Our `dynamic_array` struct would work in this context, as it can be passed around to the different functions and procedures. To avoid copies, we can pass it around our program using [pass by reference](/book/part-2-organised-code/1-structuring-code/5-reference/03c-pass-by-ref/).
