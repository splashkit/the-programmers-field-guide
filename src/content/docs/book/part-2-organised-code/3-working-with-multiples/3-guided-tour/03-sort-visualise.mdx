...
Once we start storing arrays of elements, a common operation we want to perform is sorting them! Array sorting has a wide range of applications across games and software, so in this tour we'll write a program that visualises this process graphically.

Our final program will look something like this:
