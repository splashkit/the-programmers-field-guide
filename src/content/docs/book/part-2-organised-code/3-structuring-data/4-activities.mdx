...
- Have a `StorePOS` struct with:
  - a `Product`
  - a sale count
- Be updated from the [previous iteration](/book/part-2-organised-code/2-organising-code/4-activities#store-pos--input-system) to make use of a single `StorePOS` and `Product`.
...
- Be updated from the [previous iteration](/book/part-2-organised-code/2-organising-code/4-activities#dotifin--input-system) to make use of a single `Dotifin` and `Song`.
...
- Be updated from the [previous iteration](/book/part-2-organised-code/2-organising-code/4-activities#rpg--game-loop-and-collision-tests) to make use of a single `Player`, `NPC`, and `Game`.
