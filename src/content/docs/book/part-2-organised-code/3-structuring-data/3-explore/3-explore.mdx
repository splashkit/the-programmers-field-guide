...
- Simple Database ... one value... menu
- b
- Draw UI - pass in the game details, draw the UI - health bar?
...
- Have a `StorePOS` struct with:
  - a `Product`
  - a sale count
- Be updated from the [previous iteration](/book/part-2-organised-code/2-organising-code/3-explore/3-explore#store-pos--input-system) to make use of a single `StorePOS` and `Product`.
...
- Be updated from the [previous iteration](/book/part-2-organised-code/2-organising-code/3-explore/3-explore#dotifin--input-system) to make use of a single `Dotifin` and `Song`.
...
- Be updated from the [previous iteration](/book/part-2-organised-code/2-organising-code/3-explore/3-explore#rpg--game-loop-and-collision-tests) to make use of a single `Player`, `NPC`, and `Game`.
