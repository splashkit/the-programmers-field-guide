...
To this point, data has been about single values that are either numbers, text, or Boolean values. These values can be used in [expressions](/book/part-1-instructions/2-communicating-syntax/1-concepts/03-expression) and stored in [variables](/book/part-1-instructions/1-sequence-and-data/1-concepts/07-variable). Now as we move to creating larger and more complicated programs, you need a more effective means of modelling the data in your code. This chapter introduces concepts that you can use to more accurately model the data and entities associated with your program.
