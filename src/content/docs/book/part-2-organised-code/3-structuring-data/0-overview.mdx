...
- [Enumeration](/book/part-2-organised-code/3-structuring-data/1-concepts/03-02-enum): used to store one of a list of available options.
- [Struct](/book/part-2-organised-code/3-structuring-data/1-concepts/03-01-struct): used to store multiple fields in a single composite value.
