...
We can implement `to_string` using a [switch](/book/part-1-instructions/3-control-flow/1-concepts/03-2-case) statement, with one branch per value in the enumeration.
