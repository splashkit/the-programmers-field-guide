...
We can implement `to_string` using a [switch](/book/part-1-instructions/3-control-flow/5-reference/03-2-switch) statement, with one branch per value in the enumeration.
