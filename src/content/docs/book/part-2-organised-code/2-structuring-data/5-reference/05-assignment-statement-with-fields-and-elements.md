...
- Enumeration values store a single value, so they work in the same way as described in the original [assignment statement](/book/part-1-instructions/2-data/5-reference/11-assignment-statement).
...
- The four examples from [Figure x.y](#FigureAssignmentUnion) show the following:
  1. You can assign a value to the fields of a [Union](/book/part-2-organised-code/2-structuring-data/5-reference/03-05-union). This overrides any value currently
stored in the Variable.
  2. It is possible to copy an entire Union value in the assignment.
  3. This works in the same way with arrays, you can write a value to a [Union](/book/part-2-organised-code/2-structuring-data/5-reference/03-05-union).
