...
import redLight from   '/src/content/docs/book/part-2-organised-code/4-indirect-access/2-trailside/images/slider-scope-dangling-pointer/memory-icon-unallocated-red-light.png';
import greenLight from '/src/content/docs/book/part-2-organised-code/4-indirect-access/2-trailside/images/slider-scope-dangling-pointer/memory-icon-allocated-green-light.png';
...
Think about what is happening in memory here, and think back to the details on [the stack](/book/part-2-organised-code/2-organising-code/2-trailside/01-1-the-stack) and how that works.
