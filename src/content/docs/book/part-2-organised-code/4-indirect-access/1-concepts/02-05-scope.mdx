...
Think about what is happening in memory here, and think back to the details on [the stack](/book/part-2-organised-code/2-organising-code/1-concepts/01-1-the-stack) and how that works.
