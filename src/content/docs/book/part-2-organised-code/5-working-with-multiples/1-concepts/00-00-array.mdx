...
- You can store a value in an element of an array using an [assignment statement](/book/part-2-organised-code/5-working-with-multiples/1-concepts/00-02-assign-element).
- You can use the value from an element of an array in an [expression](/book/part-2-organised-code/5-working-with-multiples/1-concepts/00-03-expressions-with-arrays).
- The [for loop](/book/part-2-organised-code/5-working-with-multiples/1-concepts/01-for-loop) works perfectly with an array, you can repeat an action *for each element of an array*.
