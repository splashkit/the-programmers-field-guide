...
The `Number Data` struct can contain the array and the count of the number of elements in the array. This will simplify passing this data around as we build this program up.
...
- Count: an integer for the current number of values
```
