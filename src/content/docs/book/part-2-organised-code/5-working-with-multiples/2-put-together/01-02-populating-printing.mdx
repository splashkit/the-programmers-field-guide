...
3. Copy in your *utilities.h* and *utilities.cpp* files from the the [shared utilities](/book/part-2-organised-code/2-organising-code/1-tour/04-00-utilities) activity. This will contain the `read_integer` and `read_double` functions we need. If either of these are missing, you should code them in your utilities files.
