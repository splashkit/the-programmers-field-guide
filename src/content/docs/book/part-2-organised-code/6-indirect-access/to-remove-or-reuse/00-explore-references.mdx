...
:::caution
If you are having trouble with this, you should go back and revise the material on how to [structure your data](/book/part-2-organised-code/2-structuring-data/0-overview). It's ok to check how you went, but avoid just copying and pasting things as this won't help you learn how to do this yourself.
:::
...
:::caution
If you are having trouble doing this yourself, make sure to go back and review [structuring code](/book/part-2-organised-code/1-structuring-code/0-overview) and [structuring data](/book/part-2-organised-code/2-structuring-data/0-overview).
:::
...
Make sure you have implemented the [read integer with a range](/book/part-2-organised-code/1-structuring-code/3-guided-tour/00-2-explore-functions/#read-integer---with-a-range) function in your shared utilities.
