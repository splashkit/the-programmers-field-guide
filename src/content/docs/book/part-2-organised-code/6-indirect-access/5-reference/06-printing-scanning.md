...
As we saw in the [preprocessor](/book/part-0-getting-started/1-building-programs/5-reference/7-1-compiling-steps#pre-processing), these functions are defined in header files, which you can include in your program using the `#include` preprocessor directive.
