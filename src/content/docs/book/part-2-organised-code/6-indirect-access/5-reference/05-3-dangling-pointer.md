...
We previously discussed the issue of [dangling pointers](/book/part-2-organised-code/6-indirect-access/5-reference/01-05-scope) in the section on scope when we looked at pointers originally. The issue is compounded when you start to manage memory yourself, as now you can dynamically allocate and free memory.
