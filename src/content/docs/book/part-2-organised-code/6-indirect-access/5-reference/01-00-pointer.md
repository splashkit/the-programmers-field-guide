...
Pointers store a value that is an address of the value that it points to. This means that you can point to any value in memory, regardless of where it is. You can have pointer values that point to [local variables](/book/part-2-organised-code/1-structuring-code/5-reference/03-local-variable), [global variables](/book/part-2-organised-code/1-structuring-code/5-reference/06-global-variables), [parameters](/book/part-2-organised-code/1-structuring-code/5-reference/04-function-decl#examples), fields of [structs](/book/part-2-organised-code/2-structuring-data/5-reference/03-01-struct) or [unions](/book/part-2-organised-code/2-structuring-data/5-reference/03-05-union).
...
A pointer value is the same as any other value. It can be stored in [local variables](/book/part-2-organised-code/1-structuring-code/5-reference/03-local-variable), [global variables](/book/part-2-organised-code/1-structuring-code/5-reference/06-global-variables), it can be passed to a function in a [parameter](/book/part-2-organised-code/1-structuring-code/5-reference/04-function-decl#examples), and it can be returned from a [function](/book/part-2-organised-code/1-structuring-code/5-reference/04-function-decl).
