...
Think about what is happening in memory here, and think back to the details on [the stack](/book/part-2-organised-code/1-structuring-code/5-reference/05-the-stack) and how that works.
