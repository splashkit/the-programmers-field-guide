...
Try converting the most recent version of your [change calculator](/book/part-2-organised-code/1-structuring-code/3-guided-tour/02-00-change-calculator) to C/C++.
