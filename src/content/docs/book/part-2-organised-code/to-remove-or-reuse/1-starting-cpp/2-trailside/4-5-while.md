...
Here is the example SplashKit event loop from the [while loop](/book/part-1-instructions/3-control-flow/5-reference/04-1-while-loop#event-loops---dynamic-graphical-programs) page.
...
Here is the C/C++ version of the [do while loop](/book/part-1-instructions/3-control-flow/5-reference/04-2-do-while#how-does-do-while-work) example.
