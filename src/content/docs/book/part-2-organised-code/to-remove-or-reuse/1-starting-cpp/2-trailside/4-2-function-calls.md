...
In C/C++, functions and procedures are the equivalent of [methods](/book/part-1-instructions/1-sequence/5-reference/03-procedure) in C#. They are functional units, things we can call on to achieve a task.
...
The code below matches the [previous example](/book/part-1-instructions/2-data/5-reference/31-function-call/#example-using-result) for calling methods in SplashKit.
