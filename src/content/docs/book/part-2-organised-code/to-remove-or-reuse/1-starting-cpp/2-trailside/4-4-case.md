...
Here is an updated version of the [case statement](/book/part-1-instructions/3-control-flow/5-reference/03-2-case#how-does-case-work) example. As our case statement is restricted to comparing integers, we use a simple menu to select between options instead of comparing strings.
