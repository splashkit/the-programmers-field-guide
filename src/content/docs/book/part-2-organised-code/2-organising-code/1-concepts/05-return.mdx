...
export const sliderReturn = [
  ...
  },
  {
    ...
    altText: "The caller receives the return value, and the program ends. Here, the shell did not use the value 0 that was returned, but sometimes if you are launching your program from a bash script, you can test the return value and print a message to the screen indicating error or success",
    tipStart: 7,
    tips: [
      "The caller receives the return value, and the program ends",
      "Here, the shell did not use the value 0 that was returned, but sometimes if you are launching your program from a bash script, you can test the return value and print a message to the screen indicating error or success"
