...
An example of how we want the program to run executing is shown in [Listing x.y](#ListingGuessingGame)
...
<div class="caption"><span class="caption-figure-nbr">Listing x.y: </span>Desired output from the guessing game</div>
