...
We can make use of our [print line](/book/part-2-organised-code/2-organising-code/1-tour/00-1-explore-procedures) procedure to help separate different games. We can also use [read string](/book/part-2-organised-code/2-organising-code/1-tour/00-2-explore-functions) to check if the user wants to run this again.
