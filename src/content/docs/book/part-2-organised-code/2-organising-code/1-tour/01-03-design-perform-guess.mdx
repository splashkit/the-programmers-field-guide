...
This sequence sounds familiar. Rather than re-coding this here, we can incorporate our `read_integer` function in the program that we created [earlier](/book/part-2-organised-code/2-organising-code/1-tour/00-2-explore-functions#read-integer).
...
:::
    <CodeActivity header="Try it out!" projectName="Organised Code/Structuring Code/Guess That Number/Perform Guess" resources="/resources/code-activities/utilities.zip">
    ```c++ {"userCode":7-14}
    #include "splashkit.h"
