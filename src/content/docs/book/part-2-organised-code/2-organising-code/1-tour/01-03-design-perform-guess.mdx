...
:::
    <CodeActivity header="Try it out!" projectName="Field Guide/Sequence and Data/Simple Calculator/Read name" resources="/resources/code-activities/utilities.zip">
    ```c++ {"userCode":7-14}
    #include "splashkit.h"
