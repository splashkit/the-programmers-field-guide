...
TODO: Update this to use C++ and functions.

Combine with potentiometer to change value based on potentiometer reading.
...
Final code with all numbers displayed in sequence (needs to be updated to C++ and using functions and potentiometer):
