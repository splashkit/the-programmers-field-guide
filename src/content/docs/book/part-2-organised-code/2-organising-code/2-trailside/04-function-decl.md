...
- The syntax for a function is just like a [procedure](/book/part-2-organised-code/2-organising-code/2-trailside/02-procedures), with a data type instead of `void`.
