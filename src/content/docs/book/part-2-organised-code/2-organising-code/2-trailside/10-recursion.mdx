...
There are a few classic problems that you often encounter when exploring recursion for the first time. We will look at how you can use recursion to create the [Fibonacci sequence](#building-the-fibonacci-sequence) and use it to solve the [Towers of Hanoi](#towers-of-hanoi).
