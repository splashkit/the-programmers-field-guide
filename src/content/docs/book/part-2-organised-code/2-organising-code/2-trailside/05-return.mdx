...
The return statement is a kind of [jump statement](/book/part-1-instructions/3-control-flow/2-trailside/05-0-jumping) that ends the current [function](/book/part-2-organised-code/2-organising-code/2-trailside/04-function-decl) or [procedure](/book/part-2-organised-code/2-organising-code/2-trailside/02-procedures). In a function, you use the return statement to provide the value that is sent back to the caller.
...
- Return statements can be combined with [branching](/book/part-1-instructions/3-control-flow/2-trailside/03-0-branching) statements to selectively end if necessary.
- In a function, a return statement **must** have an expression.
- In a procedure, a return statement **must not** have an expression.
