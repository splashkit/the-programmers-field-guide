...
export const sliderMalloc = [
  ...
  },
  {
    ...
    altText: "Line 5 prints the address of the memory space pointed to by p to the terminal",
    tipStart: 6,
    tips: [
      "Line 5 prints the address of the memory space pointed to by <strong>p</strong> to the terminal"
    ]
  },
  {
    src: sliderMalloc07.src,
    altText: "Line 6 prints the dereferenced value of  p, in this case 5155 (we've gone back to decimal representation now for simplicity)",
    tipStart: 7,
    tips: [
      "Line 6 prints the dereferenced value of  <strong>p</strong>, in this case 5155 (we've gone back to <em>decimal</em> representation now for simplicity)"
    ]
  },
  {
    src: sliderMalloc08.src,
    altText: "Line 7 assigns the dereferenced value of p, the new value of 10. You can see that the value has changed from 5155 to 10 on the heap",
    tipStart: 8,
    tips: [
...
export const sliderCalloc = [
  ...
  },
  {
    ...
    altText: "Because calloc() returns a void pointer, we need to cast it to the type of pointer our variable will hold, in this case an int pointer (step 4d)",
    tipStart: 5,
    tips: [
  ...
  },
  {
    ...
    altText: "Line 6 prints the dereferenced value of  p, in this case our initial value of 0 (we've gone back to decimal representation now for simplicity)",
    tipStart: 8,
    tips: [
      "Line 6 prints the dereferenced value of  <strong>p</strong>, in this case our initial value of 0 (we've gone back to <em>decimal</em> representation now for simplicity)"
    ]
  },
  {
    src: sliderCalloc09.src,
    altText: "Line 9 assigns the dereferenced value of p, the new value of 10. You can see that the value has changed from 0 to 10 on the heap",
    tipStart: 9,
    tips: [
      "Line 7 assigns the dereferenced value of <strong>p</strong>, the new value of 10",
