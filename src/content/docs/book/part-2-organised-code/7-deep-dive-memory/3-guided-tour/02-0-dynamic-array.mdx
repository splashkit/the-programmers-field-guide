...
Continuing from where we left off in Generics & Operators, let's develop our [generic array](/book/part-2-organised-code/5-operators-generics/3-guided-tour/02-00-generic-array/) further using concepts we've learned since then. We'll write a _dynamic array_, that automatically expands when the capacity is reached! But first, a shift in perspective.
