...
In this section we will look at building a [dynamic array](/book/part-2-organised-code/7-deep-dive-memory/3a-advanced-tour/02-0-dynamic-array) and a [linked list](/book/part-2-organised-code/7-deep-dive-memory/3a-advanced-tour/03-0-linked-list). The focus within each of these utilities will be to manage the dynamic memory allocations for us. We can then look at how we can use these within our programs.
