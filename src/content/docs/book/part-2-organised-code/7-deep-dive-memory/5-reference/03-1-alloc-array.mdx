...
int main()
{
    ...
    {
        write_line("The value on the heap is " + to_string(p[i]) + ".");
    }
    ...
    for(int i = 0; i < ARR_SIZE; i++)
    {
        write_line("The value on the heap is now " + to_string(p[i]) + ".");
    }
