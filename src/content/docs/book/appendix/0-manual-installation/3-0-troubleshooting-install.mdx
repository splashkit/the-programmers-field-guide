...
It might be helpful to go back and revise the content in the "Concepts" pages in [1: Digital Realities](/book/part-0-getting-started/1-building-programs/5-reference/1-programs) and [2: Computer Use](/book/appendix/2-computer-use/2-trailside/01-terminal) now that you have more context for how to interpret the information on those pages.
...
For a current list of common issues encountered by SplashKit users, you can look at the troubleshooting pages on the SplashKit website:

<CardGrid>
  <LinkCard
    title="Windows (MSYS2)"
    description="Common Issues on Windows (MSYS2): Troubleshooting"
    href="https://splashkit.io/troubleshoot/windows-msys2/"
  />
  <LinkCard
    title="Windows (WSL)"
    description="Common Issues on Windows (WSL): Troubleshooting"
    href="https://splashkit.io/troubleshoot/windows-wsl/"
  />
  <LinkCard
    title="MacOS"
    description="Common Issues on MacOS: Troubleshooting"  
    href="https://splashkit.io/troubleshoot/macos/"
  />
  <LinkCard
    title="Linux"
    description="Common Issues on Linux: Troubleshooting"
    href="https://splashkit.io/troubleshoot/linux/"
  />
</CardGrid>
