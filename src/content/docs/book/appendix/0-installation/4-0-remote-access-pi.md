...
The best way to connect to your Raspberry Pi is via a **secure shell** (ssh). This is the same [shell](/book/appendix/2-computer-use/2-trailside/02-shell) we introduced earlier, but accessed over the network.
