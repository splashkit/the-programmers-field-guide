...
Here is out version of the code. Remember that it is ok if your version differs from this. The main thing is to understand how to work with variables and constants, how to call functions and procedures, and how to sequence these to achieve a goal.
