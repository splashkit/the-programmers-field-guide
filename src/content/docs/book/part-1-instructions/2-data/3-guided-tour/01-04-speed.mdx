...
2. Add the code to calculate the speed and output the speed.
    ...
    The `to_string` function accepts a precision argument used to perform this. Switch the last line of code to: `write_line("Your average speed is " + to_string(speed, 2) + " km/h");`
    :::
