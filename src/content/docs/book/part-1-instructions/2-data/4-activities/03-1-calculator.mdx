...
:::caution
Make sure to only use the things we have covered. Don't worry about formatting the numbers in the output for now, just focus on getting the variables and sequence of procedure/function calls right.
:::
