...
- [ToInteger](https://splashkit.io/api/utilities/#to-integer) - can be used to convert a string to an integer.
- [ToDouble](https://splashkit.io/api/utilities/#to-double) - can be used to convert a string to a double.
