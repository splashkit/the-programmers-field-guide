...
You will need to give each variable a [data type](/book/part-1-instructions/1-sequence/5-reference/15-type/). This will determine the kind of information stored - if you want text use the `string` type, use `int` for whole number, or `double` for real numbers. We will learn about other types you can use and create in later chapters.
...
Variable declarations need to include the [type](/book/part-1-instructions/1-sequence/5-reference/15-type) of data you want to store. The name of the type is followed by the name (identifier) for the variable you want to create.
