...
In this program, we create a name variable and initialise it with a value.
...
This calculates the area of a rectangle, it creates and initialises variables for width, height, and area.
