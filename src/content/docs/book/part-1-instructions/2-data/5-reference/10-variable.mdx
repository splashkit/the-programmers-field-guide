...
You will need to give each variable a [data type](/book/part-1-instructions/2-data/5-reference/15-type/). This will determine the kind of information stored - if you want text use the `string` type, use `int` for whole number, or `double` for real numbers. We will learn about other types you can use and create in later chapters.
