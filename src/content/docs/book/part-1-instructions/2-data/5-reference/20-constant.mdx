...
Constants are generally coded outside `main`, at the top of the file. This way they are accessible throughout the program. We will explore this further when we look at tools for [organising our code](/book/part-2-organised-code/1-structuring-code/0-overview).
