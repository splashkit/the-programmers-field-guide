...
The assignment statement is an **instruction** that stores a value in a [variable](/book/part-1-instructions/2-data/5-reference/07-variable/). You use this instruction any time you want to update the value of a variable.
...
This could be a [literal](/book/part-1-instructions/1-sequence/5-reference/05-literal), a [function call](/book/part-1-instructions/2-data/5-reference/03-function), or any other [expression](/book/part-1-instructions/1-sequence/5-reference/05-expression).
...
- The left-hand side of the assignment operator is the [variable](/book/part-1-instructions/2-data/5-reference/07-variable/) into which the value is stored.
