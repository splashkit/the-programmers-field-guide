...
The assignment statement performs two actions. First, it calculates the value of the [expression](/book/part-1-instructions/1-sequence/5-reference/13-expression/) (calculation) on the right-hand side of the assignment operator (the `=`). Once it has the value, it stores the value (assigns it) to the variable on the left-hand side of the assignment operator.
...
The [expression](/book/part-1-instructions/1-sequence/5-reference/13-expression) right-hand side of `=` determines the value to be stored.
This could be a [literal](/book/part-1-instructions/1-sequence/5-reference/14-literal), a [function call](/book/part-1-instructions/2-data/5-reference/30-function), or any other [expression](/book/part-1-instructions/1-sequence/5-reference/13-expression).
...
The order of the actions in the assignment statement allows you to update the value of a variable. The following code creates a variable called `count`, initialises it to 0, and then updates its value by adding 1 to its current value.
...
At the basic level, the assignment statement uses `=` operator. To the left you put the variable name, to the right you put the value.
