...
We can [call a method](/book/part-1-instructions/2-data/5-reference/31-function-call), which gives it control of the computer, allowing it to instruct the computer.
