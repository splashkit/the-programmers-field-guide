...
We can [call a method](/book/part-1-instructions/1-sequence/5-reference/03-method-call), which gives it control of the computer, allowing it to instruct the computer.
...
* [Libraries](/book/part-1-instructions/1-sequence/5-reference/10-library) can contain many methods to perform common tasks.
