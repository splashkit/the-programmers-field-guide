...
Whenever you have information in your program that you want to be able to change, you create a variable to store it. Every variable has a [data type](/book/part-1-instructions/1-sequence/2-trailside/06-type), which needs to match the kind of data you want to store.
After you define a variable with an **identifier** and [**data type**](/book/part-1-instructions/1-sequence/2-trailside/06-type), you need to **initialise** it with a starting value.
...
Both variables and constant declarations need to include the [type](/book/part-1-instructions/1-sequence/2-trailside/06-type) of data you want to store.Then, you provide a name (identifier) for the variable or constant.
