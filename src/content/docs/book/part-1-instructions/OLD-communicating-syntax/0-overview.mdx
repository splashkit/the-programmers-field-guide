...
The path starts with a look at the concept of [grammar](/book/part-1-instructions/2-communicating-syntax/2-trailside/01-grammar). Programming language grammars describe the rules for building valid programs. One part of learning to program involves learning these rules, and how to use them to turn your ideas into code.
...
- [Statement](/book/part-1-instructions/2-communicating-syntax/2-trailside/02-statement): the technical name for an instruction.
- [Expression](/book/part-1-instructions/2-communicating-syntax/2-trailside/03-expression): a place in a statement where a value is calculated.
- [Identifier](/book/part-1-instructions/2-communicating-syntax/2-trailside/04-identifier): the used to identify a building block (eg. method, variable, constant) you have created.

In the [Guided Tour](/book/part-1-instructions/2-communicating-syntax/1-tour), we explore the way you can use syntax to help turn your ideas into code.
