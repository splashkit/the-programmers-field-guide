...
<div class="caption">An assignment statements assigns a value to a variable</div> <br/>
...
In this case, the **right-hand side** of the assignment would be a call to `ReadLine`, which reads input from [standard in](../../../../part-0-getting-started/2-computer-use/1-concepts/07-streams/#standard-input-stdin) and returns it to you.
...
<div class="caption">The C# syntax for an assignment statement</div><br/>
:::
