...
In this case, the **right-hand side** of the assignment would be a call to `ReadLine`, which reads input from [standard in](/book/appendix/2-computer-use/2-trailside/09-streams/#standard-input-stdin) and returns it to you.
