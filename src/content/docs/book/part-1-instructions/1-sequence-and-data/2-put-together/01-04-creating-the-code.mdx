...
1. Open the [terminal](../../../../part-0-getting-started/2-computer-use/1-concepts/01-terminal), or use the integrated terminal in vscode (**ctrl-\`** or **cmd-\`** is the shortcut for this).
