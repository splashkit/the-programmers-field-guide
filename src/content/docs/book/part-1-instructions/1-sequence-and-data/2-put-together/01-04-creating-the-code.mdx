...
1. Open the [Terminal](../../../../part-0-getting-started/2-computer-use/1-concepts/1-terminal) for your Operating System, or use the integrated terminal in vscode (**ctrl-\`** or **cmd-\`** are the shortcuts).
...
- Pressing the **up arrow** repeats previous commands. Once you have entered the commands to build and run the program the first time, you can switch back to that same terminal and press the "up arrow" to go back to the command to compile and run the program.
