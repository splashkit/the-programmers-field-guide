...
Remember you can have a look at our version of the code if you get stuck with any of these steps. The code is in the [campsite reflections](/book/part-1-instructions/1-sequence-and-data/4-camp/2-solutions) section.
