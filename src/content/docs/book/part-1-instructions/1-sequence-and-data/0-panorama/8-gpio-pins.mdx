...
- Explain 7-segment display (with image below)

![Diagram explaining the 7-segment display pin configuration](./images/7-segment-display-pins-explained.png)
...
![Wiring diagram to control the 7-segment display decimal point](./images/7-segment-decimal-point-circuit.png)
<div class="caption">Image created with <a href="https://fritzing.org/">Fritzing</a></div>

</TabItem>
<TabItem label="Alternative: Simple LED">

![Alternative wiring diagram using LED](./images/led-alternative-circuit.png)
<div class="caption">Image created with <a href="https://fritzing.org/">Fritzing</a></div>
