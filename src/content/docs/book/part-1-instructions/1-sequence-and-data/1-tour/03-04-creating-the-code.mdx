...
1. Open the [terminal](/book/part-0-getting-started/2-computer-use/1-concepts/01-terminal), or use the integrated terminal in VS Code (**ctrl-\`** or **cmd-\`** is the shortcut for this).
