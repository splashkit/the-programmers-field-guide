...
// Second reading
WriteLine("Release your button now so it is not pressed, then hit Enter:");
ReadLine();  // Wait for another press
...
// Third reading
WriteLine("Press your button once and release it, then hit Enter:");
ReadLine();  // Wait for another press
GpioPinValue reading3 = RaspiRead(buttonPin);
WriteLine("Reading 3: " + reading3);
RaspiWrite(ledPin, reading3);
