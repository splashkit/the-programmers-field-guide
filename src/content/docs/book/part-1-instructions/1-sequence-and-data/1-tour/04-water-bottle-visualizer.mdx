...
![The water bottle filled to 37% of its capacity.](/book/part-1-instructions/1-sequence-and-data/1-tour/images/water-exec.png)

Remember you can have a look at our version of the code if you get stuck with any of these steps. The code is in the [wrap up](/book/part-1-instructions/1-sequence-and-data/4-camp/3-water-bottle) section.
