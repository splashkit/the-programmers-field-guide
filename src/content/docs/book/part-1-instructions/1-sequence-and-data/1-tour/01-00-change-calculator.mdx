...
* [variables](/book/part-1-instructions/1-sequence-and-data/1-concepts/07-variable) to store values such as the amount paid,
* [constants](/book/part-1-instructions/1-sequence-and-data/1-concepts/07-variable#constants) for the values of the different coins, and
* [instructions](/book/part-1-instructions/1-sequence-and-data/1-concepts/00-program) to calculate and output the change expected.
