...
[Variables](/book/part-1-instructions/1-sequence-and-data/1-concepts/07-variable) and [constants](/book/part-1-instructions/1-sequence-and-data/1-concepts/07-variable/#constants) are our tools for capturing the data we need to make our program work.
...
In order to follow the steps in our [pseudocode](/book/part-1-instructions/1-sequence-and-data/2-put-together/01-01-understanding-the-change-calculator), we need a way of representing the different coins that could make up our change.
...
Have a look at the output in our [example execution](/book/part-1-instructions/1-sequence-and-data/2-put-together/01-00-change-calculator) for this program.
