...
:::note
Your goal in this stage is to come up with an idea for the [sequence](/book/part-1-instructions/1-sequence-and-data/2-trailside/01-sequence) of instructions needed to achieve our goal.
:::
...
Remember that [when you do division between two integers, you get an integer](/book/part-1-instructions/1-sequence-and-data/2-trailside/06-type#example). So 650 / 200 is 3.
