...
For example, in a basic terminal program data can flow in and out from [standard input](/book/part-0-getting-started/2-computer-use/1-concepts/09-streams).
...
- [Program](/book/part-1-instructions/1-sequence-and-data/1-concepts/00-program): a sequence of instructions that when compiled creates an executable file that a user can run.
- [Method](/book/part-1-instructions/1-sequence-and-data/1-concepts/02-method): a named group of instructions in a program that will get the computer to perform a task. When you want the task performed you can call the method.
- [Variable](/book/part-1-instructions/1-sequence-and-data/1-concepts/07-variable): allows you to **store** and **retrieve** values within a program.
- [Constant](/book/part-1-instructions/1-sequence-and-data/1-concepts/07-variable#constants): similar to a variable, except that its value cannot change after it is stored.
- [Library](/book/part-1-instructions/1-sequence-and-data/1-concepts/10-library): a collection of reusable code that can be used in programs.
- [Type](/book/part-1-instructions/1-sequence-and-data/1-concepts/06-type): defines how data is interpreted by a program. A programming language will support a number of basic types by default, and libraries can add other types.
...
- [Method Call](/book/part-1-instructions/1-sequence-and-data/1-concepts/03-method-call): tells the computer to execute the instructions in a method.
- [Assignment Statement](/book/part-1-instructions/1-sequence-and-data/1-concepts/08-assignment-statement): tells the computer to store a value in a variable or constant.
