...
In this task, it is up to you to create a short sequence of SplashKit events, such as shapes, colours, and delays acting as an introduction or title animation to a game.
