...
In this case, the **right-hand side** of the assignment would be a call to `ReadLine`, which reads input from [standard in](/book/part-0-getting-started/2-computer-use/1-concepts/09-streams/#standard-input-stdin) and returns it to you.
