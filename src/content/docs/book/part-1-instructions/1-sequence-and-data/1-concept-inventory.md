...
![Constructs to organise functionality](./images/program-concept-overview.png)
...
![Constructs to help you work with data](./images/variable-type.png)
...
![Instructions that can be run within the program](./images/statement-expression.png)
