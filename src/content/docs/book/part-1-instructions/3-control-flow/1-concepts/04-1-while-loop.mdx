...
As with [branching](/book/part-1-instructions/3-control-flow/1-concepts/03-0-branching), a while loop is a form of control flow because it literally controls the flow of instructions to the CPU.
...
In C# the while loop starts with the `while` keyword followed by the condition within parenthesis. The statement to be repeated follows this, which in almost all cases will be a [compound statement](/book/part-1-instructions/3-control-flow/1-concepts/02-0-compound-statement).
