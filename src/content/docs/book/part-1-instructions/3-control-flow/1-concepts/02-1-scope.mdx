...
export const sliderImagesStack = [
  ...
  },
  {
    ...
    altText: "The block has ended, so the top of the stack returns to the previous block",
    tipStart: 4,
    tips: [
  ...
  },
  {
    ...
    tipStart: 5,
    tips: [
      "You can no longer access the variable 'i', it is gone",
