...
- The break statement is typically coded within a [branching](/book/part-1-instructions/3-control-flow/1-concepts/03-0-branching) statement that checks if the loop should terminate early.
