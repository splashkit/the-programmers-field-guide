...
As with the [pre-test loop](/book/part-1-instructions/3-control-flow/2-trailside/04-1-while-loop), the do while loop controls the flow of instructions to the CPU.
...
As with the [while](/book/part-1-instructions/3-control-flow/2-trailside/04-1-while-loop#in-c) loop, this will almost always be a [compound statement](/book/part-1-instructions/3-control-flow/2-trailside/02-0-compound-statement).
