...
- The values on either side of the comparison are [expressions](/book/part-1-instructions/1-sequence/5-reference/13-expression), allowing you to calculate the values being compared.
