...
To find data issues, start thinking about the data and expressions in that part of the program. What variables and data were involved? Do these variables and expressions have the right values?

You can add calls to `write` or `write_line` to trace how the program executes - giving you output that shows which instructions are running, and you can output values of expressions to check your calculations.
