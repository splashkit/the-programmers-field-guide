...
When you use continue in a [while loop](/book/part-1-instructions/3-control-flow/5-reference/04-1-while-loop), you need to make sure you have updated the condition before the continue statement so that you do not end up in an infinite loop.
