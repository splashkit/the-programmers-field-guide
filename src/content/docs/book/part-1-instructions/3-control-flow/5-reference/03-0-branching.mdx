...
There are two forms of branching: [if statements](/book/part-1-instructions/3-control-flow/5-reference/03-1-if) and [case statements](/book/part-1-instructions/3-control-flow/5-reference/03-2-switch).
