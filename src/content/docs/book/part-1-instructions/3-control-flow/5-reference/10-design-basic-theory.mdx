...
You have already seen flowcharts for two of the blocks -- the pages on [branching](/book/part-1-instructions/3-control-flow/5-reference/03-0-branching) showed selection via the [if](/book/part-1-instructions/3-control-flow/5-reference/03-1-if) and [case](/book/part-1-instructions/3-control-flow/5-reference/03-2-case) statements, and the pages on [looping](/book/part-1-instructions/3-control-flow/5-reference/04-0-looping) showed repetition via the [while](/book/part-1-instructions/3-control-flow/5-reference/04-1-while-loop), [do while](/book/part-1-instructions/3-control-flow/5-reference/04-2-do-while), and [for](/book/part-1-instructions/3-control-flow/5-reference/04-3-for-loop) loop statements.
