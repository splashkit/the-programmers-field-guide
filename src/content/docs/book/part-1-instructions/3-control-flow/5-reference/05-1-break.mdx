...
export const sliderImagesBreakStatement = [
  ...
  },
  {
    ...
    altText: "The write_line() procedure executes and prints 'Bye' to the terminal. The program counter increments and the program ends",
    tipStart: 9,
    tips: [
      "The write_line procedure executes, printing 'Bye' to the terminal.",
