...
<div class="not-content">
  <YouTube id="UizWEQxUScE" params="fs=1&modestbranding=1&rel=0&autoplay=1"/>
</div>
...
- As with [branching](/book/part-1-instructions/3-control-flow/2-trailside/03-0-branching), looping statements have a single entry and a single exit.
