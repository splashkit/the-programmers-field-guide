...
<div class="not-content">
  <YouTube id="l9jxS9f2inU" params="fs=1&modestbranding=1&rel=0"/>
</div>
...
There are two forms of branching: [if statements](/book/part-1-instructions/3-control-flow/2-trailside/03-1-if) and [case statements](/book/part-1-instructions/3-control-flow/2-trailside/03-2-case).
