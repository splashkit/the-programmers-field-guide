...
<div class="not-content">
  <YouTube id="zIV4poUZAQo" params="fs=1&start=104&modestbranding=1&rel=0"/>
</div>

:::note[Summary]

- The break statement is an **instruction** allowing you to jump to the end of the current loop.
- The break statement is typically coded within a [branching](/book/part-1-instructions/3-control-flow/2-trailside/03-0-branching) statement that checks if the loop should terminate early.
