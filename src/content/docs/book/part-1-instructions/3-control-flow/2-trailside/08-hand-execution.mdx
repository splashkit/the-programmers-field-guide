...
![Example of hand execution for a variable that goes out of scope](./images/hand-execution-scope.png)

:::tip
Remember variables exist within a given [scope](/book/part-1-instructions/3-control-flow/2-trailside/02-1-scope). When the variable goes out of scope it is destroyed, so you cannot access it any longer.
:::
