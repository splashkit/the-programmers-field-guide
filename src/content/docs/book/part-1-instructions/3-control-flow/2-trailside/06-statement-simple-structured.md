...
We have already seen that a [program](/book/part-1-instructions/1-sequence/2-trailside/00-program) is just a list of statements, as is a [compound statement](/book/part-1-instructions/3-control-flow/2-trailside/02-0-compound-statement).
...
- **Simple Statements** that perform an action. The actions you can perform are:
  - [Method Call](/book/part-1-instructions/1-sequence/2-trailside/03-method-call): run the code in a method.
  - [Assignment Statement](/book/part-1-instructions/1-sequence/2-trailside/08-assignment-statement): store a value in a variable.
