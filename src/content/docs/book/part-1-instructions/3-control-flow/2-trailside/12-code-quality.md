...
Programming is all about building our own digital realities. These abstract models that run within the computer are built from many building blocks. So far we have seen how to create [variables](/book/part-1-instructions/1-sequence/2-trailside/07-variable) and [constants](/book/part-1-instructions/1-sequence/2-trailside/07-variable#constants). Next, we will start looking at building other code constructs to help organise our code into reusable components. All of these things that we create need **names**.
...
We have also [mentioned this before](/book/part-1-instructions/1-sequence/2-trailside/09-comments), but it is important enough to reiterate.
