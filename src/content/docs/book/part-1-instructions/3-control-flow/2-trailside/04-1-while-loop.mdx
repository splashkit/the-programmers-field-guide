...
:::caution
At some point you will end up with an unexpected infinite loop. In these cases, you need to remember the details on how to [signal](/book/part-0-getting-started/2-computer-use/1-concepts/10-signals) the operating system. You can use the ctrl-c to [kill](/book/part-0-getting-started/2-computer-use/1-concepts/10-signals#killing-a-program-ctrl-c) the program.
:::
