...
We will explore this further in the [guided tour](/book/part-1-instructions/1-sequence/1-tour/00-overview) and [trailside stop](/book/part-1-instructions/1-sequence/2-trailside/11-2-graphics). For now, it is enough to remember that these methods exist.
