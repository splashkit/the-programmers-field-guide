...
- [Procedures](/book/part-1-instructions/1-sequence/5-reference/02-procedure) that can be called to perform an action or fetch/calculate a value.
- [Libraries](/book/part-1-instructions/1-sequence/5-reference/10-library) that provide you with building blocks others have created.

You will be able to instruct the computer to:

- [Call procedures](/book/part-1-instructions/1-sequence/5-reference/03-procedure-call) to run the instructions they contain.
...
- Calculated values ([expressions](/book/part-1-instructions/1-sequence/5-reference/04-expression)) are evaluated before they are used. This process obeys standard mathematical rules (e.g. [BOMDAS](https://en.wiktionary.org/wiki/BOMDAS#:~:text=English-,Phrase,division%2C%20then%20addition%20and%20subtraction)).
