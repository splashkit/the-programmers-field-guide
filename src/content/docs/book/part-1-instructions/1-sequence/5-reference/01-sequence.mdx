...
- [Procedures](/book/part-1-instructions/1-sequence/2-trailside/02-procedure) that can be called to perform an action or fetch/calculate a value.
...
- [Call procedures](/book/part-1-instructions/1-sequence/2-trailside/03-procedure-call) to run the instructions they contain.
