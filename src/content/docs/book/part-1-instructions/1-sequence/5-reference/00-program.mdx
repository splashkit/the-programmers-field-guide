...
These allow you to tell the compiler to give you access to [procedures](/book/part-1-instructions/1-sequence/5-reference/03-procedure) declared in [libraries](/book/part-1-instructions/1-sequence/5-reference/10-library) you want to use.
...
Because of this, C++ and virtually all programming languages include syntax for writing [**code comments**](/book/part-1-instructions/1-sequence/5-reference/09-comments).
...
- Your program can use code from [libraries](/book/part-1-instructions/1-sequence/5-reference/10-library), giving it access to procedures (and other constructs) others have created.
