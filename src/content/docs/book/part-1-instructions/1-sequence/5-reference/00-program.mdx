...
![The simplified syntax for a C++ program](./images/program-cpp-simple.png "The simplified syntax for a C++ program")
<CommmonLink type="syntaxDiagramGuide"/>
:::

Each program starts with an optional list of **header includes**.
These allow you to tell the compiler to include extra files that declare new [procedures and functions](/book/part-1-instructions/1-sequence/5-reference/02-procedure) that you call in your program.
...
- Your program can use code from [libraries](/book/part-1-instructions/1-sequence/5-reference/10-library), giving it access to building blocks others have created.
