...
This can be either a **number value** or **text value** written directly in the code, and can be a whole, or part of, an [expression](/book/part-1-instructions/1-sequence/2-trailside/04-expression).
