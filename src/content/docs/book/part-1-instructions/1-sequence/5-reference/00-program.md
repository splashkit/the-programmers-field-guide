...
These allow you to tell the compiler where you want it to look for the [methods](/book/part-1-instructions/1-sequence/2-trailside/02-method) you call in your program.
...
This allows you to use the [methods](/book/part-1-instructions/1-sequence/2-trailside/02-method) from this part of the library in your code.
:::
