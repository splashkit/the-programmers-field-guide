...
When you are creating a program you define the actions the computer will perform when the program is run. Each of these instructions is coded as a **statement** within the program. This style is called [imperative programming](/book/part-1-instructions/1-sequence/5-reference/80-other-languages#imperative-programming-paradigms). Imperative means to give authoritative commands, and that is what we do in our programs. Our programs are lists of authoritative commands (statements) that *tell* the computer the actions it is to perform.
...
As you learn to program, you will need to learn all the different kinds of instructions you can give the computer. These will be **statements** in the programming languages you learn. Just knowing that **statement** means **instruction** will help you engage with language documentation and resources.
...
- Learning a language involves learning the different kinds of statements it has and how to write them in code.
:::
