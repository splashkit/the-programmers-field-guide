...
1. Add a call to open a window that we can draw onto.
    ...
    In SplashKit you can open a window to draw onto. To open the window you call the `open_window` method, and pass it the window’s title, its width and its height.
