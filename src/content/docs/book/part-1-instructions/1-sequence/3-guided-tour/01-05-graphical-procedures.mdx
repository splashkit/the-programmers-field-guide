...
:::tip
These are procedure declarations - the code used to create a procedure. This code is in the library where these are made. You can call these in your code by using the name of the procedure, and passing it the values it asks for.

For example:
```c++
# This code creates open_window - a procedure you can call
window open_window(string caption, int width, int height);
```

To use it you would do something like:
```c++
# The procedure call -- with caption, width and height
