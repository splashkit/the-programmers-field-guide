...
- [Statement](/book/part-1-instructions/2-communicating-syntax/1-concepts/02-statement): the technical name for an instruction.
- [Expression](/book/part-1-instructions/2-communicating-syntax/1-concepts/03-expression): a place in a statement where a value is calculated.
- [Identifier](/book/part-1-instructions/2-communicating-syntax/1-concepts/04-identifier): the used to identify a building block (eg. method, variable, constant) you have created.

In [Putting it Together](/book/part-1-instructions/2-communicating-syntax/2-put-together), we explore the way you can use syntax to help turn your ideas into code.
