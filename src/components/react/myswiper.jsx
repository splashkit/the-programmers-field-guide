...
export default ({ images }) => {
  ...
  for (const image of images) {
    var imagePath, altText, tipAside = "";
    ...
    imageSlots.push(
      <SwiperSlide key={imagePath}>
        <img alt={image.altText} src={imagePath}></img>
        {tipAside}
      </SwiperSlide>
    );
  }
